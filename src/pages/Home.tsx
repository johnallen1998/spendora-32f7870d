...
const Home: React.FC = () => {
  ...
  return (
    <div className={`px-4 pb-28 pt-6 ${isDark ? "bg-gray-900" : "bg-gray-50"}`}>
      <div className="flex justify-between items-center animate-fade-in mb-8">
        <div>
          <h2 className={`text-lg mb-1 ${isDark ? "text-gray-400" : "text-gray-500"}`}>Hello,</h2>
      ...
      <section className="animate-fade-in">
        ...
        <div className="grid grid-cols-2 gap-3 mb-8">
          ...
          <Card className={`p-4 shadow-sm hover:shadow-md transition-shadow rounded-xl animate-scale-in ${
            ...
            <p className={`text-xs mb-1 text-center ${isDark ? "text-gray-400" : "text-gray-500"}`}>Total Expenses</p>
          ...
          {categories.slice(0, 3).map((category, index) => (
            ...
            >
              ...
              <p className={`text-xs mb-1 capitalize truncate text-center ${isDark ? "text-gray-400" : "text-gray-500"}`}>
                {category.name}
              </p>
              <h3 className={`text-xl font-bold text-center ${isDark ? "text-white" : "text-gray-900"}`}>
