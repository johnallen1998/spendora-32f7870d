...
const Home: React.FC = () => {
  ...
  return (
    <div className="px-4 pb-28 pt-6">
      <div className="flex justify-between items-center animate-fade-in mb-5">
        <div>
      ...
      <div className="mb-6 animate-fade-in stagger-delay-1">
        <SearchBar 
          className="w-full" 
      ...
      <section className="animate-fade-in stagger-delay-2">
      ...
      <section className="mb-8 animate-fade-in stagger-delay-4">
      ...
      <section className="mb-8 animate-fade-in stagger-delay-5">
        <BudgetGoals />
      </section>

      <section className="animate-fade-in stagger-delay-6">
        <div className="flex justify-between items-center mb-3">
